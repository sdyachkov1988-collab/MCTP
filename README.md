...
- first-live 4TF strategy enhancement: `MONTHLY/W1` now enter `StrategyInput` as read-only macro context while `D1/H4/H1/M15` remain the active trading core and `M15 ATR` remains the volatility/risk layer
